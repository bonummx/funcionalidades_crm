						...
						elseif (isset($focus->popup_fields) && in_array($fieldname, $focus->popup_fields)) {
							...
							if (isset($forfield) && $forfield != '' && $focus->popup_type != 'detailview') {
								...
								if (property_exists($focus, 'popup_function') && !empty($focus->popup_function)) {
									...
									if (strpos($forfield, 'custom_Project') !== false || strpos($forfield, 'custom_CobroPago') !== false || strpos($forfield, 'custom_Vendors') !== false) {
										$value = "<a href='#' onclick='return vtlib_setvalue_from_popup($entity_id, \"$value\", \"$forfield\"".(empty($forform)?'':',"'.$forform.'"').")' id =$count >$value1</a>";
									}else if (strpos($forfield, 'cf_13815') !== false) {
										$value = "<a href='#' onclick='return vtlib_setvalue_from_popup($entity_id, \"$value\", \"$forfield\"".(empty($forform)?'':',"'.$forform.'"').")' id =$count >$value1</a>";
									}else {
		...
		if ($fieldname == $focus->list_link_field) {
			if ($mode == "search") {
				...
				if (($module == "Leads" && $colname == "lastname") || ($module == "Contacts" && $colname == "lastname")) {
					...
					if ($opennewtab=='') {
						if ($module == 'checklistdoc' ||
$module == 'Vendors' ||
$module == 'odan' ||
$module == 'trackaprobaciones' ||
$module == 'trackasignaciones' ||
$module == 'avalesn' ||
$module == 'blaster' ||
$module == 'Campaigns' ||
$module == 'cartaterminos' ||
$module == 'catalogotasas' ||
$module == 'clientescartera' ||
$module == 'comfstn' ||
$module == 'complementopfn' ||
$module == 'complementopmn' ||
$module == 'consultaburo' ||
$module == 'consultadeimpuestos' ||
$module == 'consultadetallerfc' ||
$module == 'consultarfcs' ||
$module == 'Quotes' ||
$module == 'creditosolicitudn' ||
$module == 'declaraciones' ||
$module == 'resumen' ||
$module == 'dictamenadicionaln' ||
$module == 'dictamenprospecton' ||
$module == 'Documents' ||
$module == 'Emails' ||
$module == 'cbSurveyDone' ||
$module == 'facturacion' ||
$module == 'HelpDesk' ||
$module == 'formalizacionn' ||
$module == 'garantiasn' ||
$module == 'historicotasas' ||
$module == 'incilegalesn' ||
$module == 'infofinanciera' ||
$module == 'calllistc' ||
$module == 'idcsn' ||
$module == 'investigadosn' ||
$module == 'CobroPago' ||
$module == 'lineacredsimple' ||
$module == 'lineacredeudor' ||
$module == 'numerosolicitudc' ||
$module == 'sms' ||
$module == 'modnegon' ||
$module == 'numsolicitud' ||
$module == 'SalesOrder' ||
...
$module == 'pldn' ||
$module == 'poderesn' ||
$module == 'princlientesn' ||
$module == 'princompn' ||
$module == 'directivos' ||
$module == 'prinprovn' ||
$module == 'Products' ||
$module == 'qeqcomn' ||
$module == 'qeqadicionalesn' ||
$module == 'quienesquienn' ||
$module == 'refbancariasn' ||
$module == 'refcompron' ||
$module == 'reformasn' ||
$module == 'cbRelations' ||
$module == 'Services' ||
$module == 'cbCalendar' ||
$module == 'tracksolicitud') {
							$target = "_blank";
						}else {
							$target = "_self";
						}
